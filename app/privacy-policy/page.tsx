      ...
      <div className="container mx-auto grid grid-cols-1 px-5 md:px-20 pt-32 lg:pt-20">
        ...
        <div className="shadow p-5">
          ...
          <p>
            ...
            to us. This privacy policy outlines the types of personal
            information that is received and collected by abassdev.com and how
            it is used.
          </p>
        </div>
        ...
        <div className="shadow p-5">
          ...
          <p>
            ...
            website. You can learn more about how Google uses cookies by
