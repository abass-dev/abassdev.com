import { Footer, Report } from "@/components";
...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <div className="dark:text-white dark:bg-gray-900">
        <div className="container mx-auto grid grid-cols-1 px-5 md:px-20 pt-32 lg:pt-20">
          ...
          <div className="shadow p-5">
            ...
            <p>
              At abassdev.com, the privacy of our visitors is of utmost
              importance to us. This privacy policy outlines the types of
              personal information that is received and collected by
              abassdev.com and how it is used.
            </p>
          </div>
          ...
          <div className="shadow p-5">
            ...
            <p className="mb-3">
              ...
              address, and other contact details when you fill out the contact
              form on our website. This information is collected solely for the
              purpose of communicating with you regarding your inquiry or
              request.
            </p>
            <p>
              We may also collect non-personal information such as your IP
              address, browser type, operating system, and the date and time of
              your visit. This information is used to analyze trends, administer
          ...
          <div className="shadow p-5">
            ...
            <p className="mb-3">
              ...
              use our website. Google Analytics collects information such as how
              often users visit our website, what pages they visit when they do
              so, and what other sites they used prior to coming to our website.
              We use the information we get from Google Analytics to improve our
            ...
            <p>
              Google may use cookies to collect information about your use of
              our website. You can learn more about how Google uses cookies by
              visiting Google's Privacy & Terms page.
            </p>
          </div>
      ...
      <Report report="privacy-policy/page" />
      <Footer />
    </>
  );
};
