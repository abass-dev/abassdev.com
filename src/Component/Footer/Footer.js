    ...
    <div id='contact' className="row py-4 ">
      <div className="ff-ubuntu col-md-6 d-flex flex-column align-items-center text-center justify-content-center">
        ...
        <div className='m-2 rounded border p-1'>
          <a className="link-secondary" href='/privacy-policy'>Privacy Policy</a>
        </div>
        <div className='m-2 rounded border p-1'>
          <a className="link-secondary" href='/contact'>Contact me</a>
        </div>
        <div className='m-2 rounded border p-1'>
          <a className="link-secondary" href='/mystory'>My story</a>
        </div>
      </div>
