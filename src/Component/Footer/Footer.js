 ...
 return (
    <div className="row bg-light pt-1">
      <div className="col-md-6 text-center">
        ...
        <h2>Let's Connect</h2>
        <p>
        If you're interested in working on a project or have any questions, please feel free to leave me an email, and I'll get back to you as soon as possible</p>
      </div>
