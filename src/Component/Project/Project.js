...
export default function Project({ pathName }) {
  ...
  return (
    <div id={pathName ? storedTheme : ''}>
      ...
      <div className={pathName ? 'container-lg mt-4' : 'mt-4'}>
        <div className='row'>
            ...
            <div className='projetRefId card border-0 shadow-sm slide-first'>
              <div className='card-body'>
                ...
                <p className='border-bottom pb-2'>
                  ...
                  <a className='text-center' href='https://packagist.org/packages/nigatedev/nigatedev' title='version'>
                    <img
                      alt='NigaPHP Framework'
            ...
            <div className='projetRefId slide-second card border-0 shadow-sm'>
              <div className='card-body '>
                ...
                <p className='md-title'>
                  ...
                  project created by Abass Dev. The project is coded with PHP and styled using Bootstrap CSS, making it
                  simple to create custom forms with ease.
                </p>
                <p>
