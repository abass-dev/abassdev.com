...
export default function Profile() {
  return (
    <div id='apropos' className='mb-5'>
      <div id='about' className='row py-5 align-items-center'>
        <div className='d-flex  pb-4 justify-content-center align-items-center profileImageRefId  col-md-4'>
          <img alt={'Abass Dev'} width={300} height={300} className='fluid text-center rounded' src={ProfilePicture} />
        </div>
        <div itemscope='' itemtype='http://schema.org/Person' className='col-md-8 text-center'>
          <div className='ff-ubuntu'>
            <h1 className='primary-font fw-bold text-start primary-text'>Abass Dev</h1>
