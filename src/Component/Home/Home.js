    ...
    if (!cookie.alertbox) {
      return (
        <div className="showcookie">
          <p>
            <span className="text-warning bg-light">NOTE:</span> This Website
            uses Google cookies to provide services and analyze traffic.{" "}
            <a href="https://policies.google.com/technologies/cookies?hl=en-US">
              Learn abou it
            </a>
          </p>
          <button className="btn btn-outline-danger" onClick={handle}>
            OK
          </button>
        </div>
      );
