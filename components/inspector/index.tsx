        ...
        >
          ...
          {loading && (
            <>
              <div className="mt-8 col-span-2">
                <ProgressBar />
                <p className='text-center text-blue-500 mt-4 first-letter:uppercase'>{service} repository detected! Please wait...</p>
              </div>
            </>
          )}
          <div className="col-span-2 mt-8">
            <div className="flex mt-8">
              ...
              <div className="ms-2 text-sm">
                ...
                >NOTE: Only [github and gitlab] are now supported 
                  E.g: https://github.com/abass-dev/abassdev.com
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-2 bg-white dark:bg-gray-800 dark:text-gray-100 shadow p-4">
            ...
            <div className="grid grid-cols-1 gap-6">
              <p>
                ...
                repositories. With Repo Inspector, you gain a powerful tool that
                goes beyond the surface level, allowing you to unlock a wealth
                of information about your codebase.
              </p>
              <p>
              ...
              <p>
                ...
                commit history, code contributors, and overall project activity.
                With this wealth of information, you can better understand the
                evolution of your codebase, identify key contributors, and make
              ...
              <p>
                ...
                Uncover hidden gems, identify areas for improvement, and harness
                the true potential of your codebase. Elevate your development
