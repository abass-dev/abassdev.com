        ...
        <div className="container mx-auto px-8 md:px-10 lg:px-20 xl:px-32">
          <div className="flex justify-center gap-6 p-3 items-center bg-gray-400">
            ...
            <h1 className="uppercase text-white text-4xl">
              <span className="text-yellow-700">R</span>epo{" "}
              <span className="text-yellow-700">I</span>nspector
            </h1>
          </div>
          ...
          <div className="py-3">
            ...
            >
              ...
              <div
                className={!fullUrlState ? "hidden col-span-2" : "col-span-2"}
              >
                <label
              ...
              <div
                className={fullUrlState ? "hidden col-span-1" : "col-span-1"}
              >
                <label
                  className={`block uppercase tracking-wide ${
              ...
              <div className={`${fullUrlState ? "mt-8" : ""} col-span-2`}>
                <button
                  ...
                  className="bg-blue-800 flex items-center justify-center gap-2 bg-transparent w-full hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"
                >
              ...
              <div className="col-span-2 bg-white dark:bg-gray-800 dark:text-gray-100 shadow p-4">
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <p>
                    Imagine being able to effortlessly inspect your repository
                    and unveil its true potential. Repo Inspector enables you to
                    delve into the intricacies of your project, providing you
                    with comprehensive metrics and detailed analysis. By
                    leveraging the power of advanced algorithms and cutting-edge
                    technology, Repo Inspector equips you with the knowledge you
                    need to make informed decisions and drive your project
                    forward.
                  </p>
                  <p>
                    Upon inspecting a repository with Repo Inspector, you gain
                    access to a plethora of invaluable information. Dive deep
                    into the codebase and discover the exact number of lines of
                    code, offering you an overview of its complexity and scale.
                    Uncover the technologies utilized within the repository,
                    providing crucial insights into the underlying frameworks,
                    programming languages, and tools employed.
                  </p>
                  <p>
                    But it doesn't stop there. Repo Inspector also reveals the
                    number of files present in your repository, allowing you to
                    grasp its structure and organization at a glance.
                    Furthermore, the project offers additional metrics and
                    analytics, including commit history, code contributors, and
                    overall project activity. With this wealth of information,
                    you can better understand the evolution of your codebase,
                    identify key contributors, and make informed decisions to
                    improve efficiency and productivity.
                  </p>
                  <p>
                    Repo Inspector boasts a user-friendly interface, making it
                    effortless for developers of all levels to explore and
                    analyze their repositories. Whether you're a seasoned
                    professional or just starting out, Repo Inspector empowers
                    you to gain a comprehensive understanding of your project's
                    inner workings, facilitating better collaboration,
                    decision-making, and optimization.
                  </p>
                  <p>
                    Take control of your repository's destiny with Repo
                    Inspector. Uncover hidden gems, identify areas for
                    improvement, and harness the true potential of your
                    codebase. Elevate your development process, enhance
                    productivity, and ensure the success of your projects with
                    this invaluable inspection tool.
                  </p>
                  <p>
                    CREDIT: Thanks to{" "}
