    ...
    <div className="xpt py-8 md:px-20">
      ...
      <div className="shadow-lg grid grid-cols-1 gap-8 m-5 p-5">
        ...
        <p>
          ...
          While Abass Dev strives to keep the information on this website
        ...
        <p>
          In no event will Abass Dev be liable for any loss or damage including
        ...
        <p>
          ...
          not under the control of Abass Dev. We have no control over the
        ...
        <p>
          ...
          However, Abass Dev takes no responsibility for, and will not be liable
