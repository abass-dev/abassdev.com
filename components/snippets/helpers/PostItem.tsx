...
const PostItem = ({ data }: { data: PostItem[] }) => {
  return data.map((item) => {
    return (
      <div
        key={item.id}
        className="max-h-[560px] flex flex-col-reverse lg:flex-row overflow-auto dark:shadow-gray-950 bg-white shadow dark:bg-gray-800"
      >
        <div className="flex-1">
          <div className="p-5">
            <h2 className="text-4xl mb-10">{item.title}</h2>
