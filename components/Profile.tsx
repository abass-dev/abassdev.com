            ...
            <div className="space-y-8 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                {t.rich('bio.description', {
                  blog: (chunks) => (
                    <Link href="https://abassdev.com/blog" className="text-blue-950 dark:text-white underline underline-offset-1 hover:text-primary transition-colors">
                      {chunks}
                    </Link>
                  ),
                  openSource: (chunks) => (
                    <Link href="https://github.com/abass-dev" className="text-blue-950 dark:text-white underline underline-offset-1 hover:text-primary transition-colors">
                      {chunks}
                    </Link>
                  ),
                  nigaPHP: (chunks) => (
                    <Link href="https://github.com/nigaphp" className="text-blue-950 dark:text-white underline underline-offset-1 hover:text-primary transition-colors">
                      {chunks}
                    </Link>
                  ),
                  webUtilityX: (chunks) => (
                    <Link href="https://apps.abassdev.com" className="text-blue-950 dark:text-white underline underline-offset-1 hover:text-primary transition-colors">
                      {chunks}
                    </Link>
                  ),
                  openReactHub: (chunks) => (
                    <Link href="https://orh.vercel.app" className="text-blue-950 dark:text-white underline underline-offset-1 hover:text-primary transition-colors">
                      {chunks}
                    </Link>
                  )
                })}
