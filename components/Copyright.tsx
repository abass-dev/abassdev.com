    ...
    <>
      ...
      <div className="bg-gray-200 dark:bg-gray-900 xpt py-8 md:px-20">
        <div className="shadow-lg container mx-auto dark:shadow-slate-900  bg-white dark:bg-gray-800 grid grid-cols-1 gap-8 m-5 p-5">
          ...
          <p>
            The materials and content displayed on this website, including but
            not limited to text, graphics, logos, images, videos, and software,
            are the property of Abass Dev or its content suppliers and are
            protected by international copyright laws. Reproduction,
            modification, distribution, or any other form of exploitation of the
            materials and content on this website is prohibited without express
            written consent from Abass Dev.
          </p>
          <p>
            The information and materials provided on this website are for
            general informational purposes only and do not constitute
            professional advice. While Abass Dev strives to keep the information
            on this website accurate and up-to-date, we make no representations
          ...
          <p>
            In no event will Abass Dev be liable for any loss or damage
          ...
          <p>
            ...
            are not under the control of Abass Dev. We have no control over the
          ...
          <p>
            ...
            However, Abass Dev takes no responsibility for, and will not be
