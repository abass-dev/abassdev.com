      ...
      <div className="max-w-3xl mx-auto rounded overflow-hidden shadow-lg">
        ...
        <div className="px-6 grid grid-cols-1 gap-4 py-4">
          ...
          <p className="text-gray-700 text-base">
            ...
            full-stack developer with a passion for building exceptional Web and
            Mobile applications. He was born in Niamey, Niger, on February 2,
            1994. He is currently {birthday(new Date("02-02-1994"))}
          </p>

          <p className="text-base text-gray-700">
            At a young age of 15 in 2009, Abass Dev became fascinated with the
            world of web development. However, he had no idea where to start. It
            wasn't until he met a friend on Skyrock, a social networking site,
            in 2011, that he was introduced to the world of blogging and tasked
            with administering a Wix-created blog. It was this experience that
            sparked his curiosity and ignited his passion for web development.
          </p>

          <p className="text-base text-gray-700">
            In 2012, Abass Dev created his first blog on the Blogspot platform,
            but soon discovered its limitations. Determined to expand his
            knowledge and capabilities, he began to explore the depths of web
            development using languages such as HTML, CSS, JavaScript, PHP, SQL,
            and others.
          </p>
          <p className="text-base text-gray-700">
          ...
          <p className="text-base text-gray-700">
            In addition to his technical abilities, Abass Dev has a keen eye for
          ...
          <p className="text-base text-gray-700">
            ...
            to become a respected figure in the web development community, and a
            source of inspiration for aspiring developers around the world.
          </p>
        </div>
      </div>
    </div>
