        ...
        <div className="max-w-3xl mx-auto rounded overflow-hidden shadow-lg">
          ...
          <div className="px-6 grid grid-cols-1 gap-4 py-4">
            ...
            <p className="text-base text-gray-700">
              ...
              site, in 2011, that he was introduced to the world of blogging and
              tasked with administering a Wix-created blog. It was this
              experience that sparked his curiosity and ignited his passion for
              web development.
            </p>
            ...
            <p className="text-base text-gray-700">
              ...
              a source of inspiration for aspiring developers around the world.
            </p>
          </div>
        </div>
      </div>
